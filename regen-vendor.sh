...
VENDOR_SKIP_FILES=(
    ...
    "bin/hw/android.hardware.vibrator-service.cs40l26-private"
    ...
    "etc/display_colordata_cal1.pb"
    "etc/display_colordata_dev_cal1.pb"
    "etc/display_golden_cal0.pb"
    "etc/display_golden_cal1.pb"
    "etc/fs_config_dirs"
    "etc/fs_config_files"
    "etc/fstab.gs201"
    ...
    "etc/init/android.hardware.vibrator-service.cs40l26-private.rc"
    ...
    "etc/modem/camera_front_inner_mipi_coex_table.csv"
    "etc/modem/default.cfg"
    "etc/modem/default.nprf"
    "etc/modem/default_metrics.xml"
    "etc/modem/display_secondary_mipi_coex_table.csv"
    ...
    "etc/permissions/android.hardware.sensor.hinge_angle.xml"
    ...
    "etc/thermal_info_config_proactive_skin.json"
    "etc/ueventd.rc"
    ...
    "etc/vintf/manifest/android.hardware.vibrator-service.cs40l26-private.xml"
