...
PRODUCT_COPY_FILES += \
    ...
    device/google/felix/audio/$(AUDIO_TABLE_FOLDER)/config/audio_policy_volumes.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.xml

# AudioEffectHAL Configuration
PRODUCT_COPY_FILES += \
    device/google/felix/audio/$(AUDIO_TABLE_FOLDER)/config/audio_effects.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects.xml
...
SPK_FIRMWARE_FULL_PATH := device/google/felix/audio/$(SPK_FIRMWARE_PATH)
